...
$(document).ready(function () {
    $('<audio id="chatAudio"><source src="../Content/Music/notify.ogg" type="audio/ogg"><source src="../Content/Music/notify.mp3" type="audio/mpeg"><source src="../Content/Music/notify.wav" type="audio/wav"></audio>').appendTo('body');
...
function createPrivateChatWindow(chatHub, userId, ctrId, userName, chatTitle) {
    ...
    $('#' + ctrId).siblings().append("<div id=\"typing_" + userId + "\" style=\"width:20px; height:20px; display:none; position:absolute; right:14px; top:8px\">..........<span class='fa fa-pencil'></div>");
